...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    group: 'deco',
    sub: 'Proefstuk',
    name: 'Gratis proefstuk cortenstaal',
    dims: '10 × 10 cm, set van 2',
    img: '/img/proefstuk.jpg',
    price: 0,
    desc: 'Twee plaatjes van 10 × 10 cm uit onze eigen productie: één blank gewalst en één voorverroest. Zo zie je precies hoe het staal kleurt en voelt vóór je bestelt. Gratis, maximaal één set per adres.',
    variants: [['10 × 10 cm, set van 2', 0]],
    options: [],
    leadtime: '2 tot 3 werkdagen',
  },
  {
    id: 'den',
    group: 'deco',
